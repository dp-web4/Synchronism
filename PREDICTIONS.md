...
| Locality is the discriminating axis (positioning) | The local-density mimics are refuted (C(ρ) γ=2 ΔBIC=+184; ρ_crit(V) sign-inverted) **and** the surviving relativistic-MOND theory is *non-local* — **AeST** (Skordis–Złošnik, PRL 127 161302, 2021), keyed on \|∇Φ\|, passes CMB. Same statement from two sides ⇒ locality is the discriminator (Milgrom 2005). AeST is the escape-class existence proof; caveat "AeST-*class*," not AeST-specifically (post-2021 stability concerns). Strengthens the #1 transferable null for a preprint (dp's call). Triage `explorations/2026-07-03-triage-locality-nogo-aest-positioning.md` | 2026-07-03 (maintainer + triage) |
