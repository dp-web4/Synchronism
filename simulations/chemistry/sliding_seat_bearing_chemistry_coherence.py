...
fig.suptitle('Chemistry Session #2604: Sliding Seat Bearing Chemistry - γ~1 Coherence Analysis\n2467th Phenomenon Type | Finding #2531', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/sliding_seat_bearing_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
