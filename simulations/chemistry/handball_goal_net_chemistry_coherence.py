...
fig.suptitle('Chemistry Session #2644: Handball Goal Net Chemistry - γ~1 Coherence Analysis\n2507th Phenomenon Type | Finding #2571', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/handball_goal_net_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
