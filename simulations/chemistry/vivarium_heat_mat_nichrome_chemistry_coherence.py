...
fig.suptitle('Chemistry Session #2526: Vivarium Heat Mat Nichrome Wire - γ~1 Coherence Analysis\n2389th Phenomenon Type | Finding #2453', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/vivarium_heat_mat_nichrome_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
