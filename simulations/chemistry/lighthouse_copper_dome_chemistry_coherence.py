...
fig.suptitle('Chemistry Session #2386: Lighthouse Copper Dome Chemistry - Copper Patina Verdigris Formation on Lighthouse Dome Weathering\n- \u03b3~1 Coherence Analysis | 2249th Phenomenon Type | Finding #2313', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/lighthouse_copper_dome_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
