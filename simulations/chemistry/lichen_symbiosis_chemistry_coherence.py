...
fig.suptitle('Chemistry Session #2370: Lichen Symbiosis Chemistry - γ~1 Coherence Analysis\n2233rd Phenomenon Type | Finding #2297', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/lichen_symbiosis_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
