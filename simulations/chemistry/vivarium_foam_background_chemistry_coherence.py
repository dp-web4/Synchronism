...
fig.suptitle('Chemistry Session #2530: Vivarium Foam Background Expanding PU - γ~1 Coherence Analysis\n2393rd Phenomenon Type | Finding #2457', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/vivarium_foam_background_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
