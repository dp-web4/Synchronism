...
fig.suptitle('Chemistry Session #2640: Chest Protector Foam Chemistry - γ~1 Coherence Analysis\n2503rd Phenomenon Type | Finding #2567', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/chest_protector_foam_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
