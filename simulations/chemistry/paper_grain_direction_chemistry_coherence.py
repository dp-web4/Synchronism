...
fig.suptitle('Chemistry Session #2587: Paper Grain Direction Chemistry - γ~1 Coherence Analysis\n2450th Phenomenon Type | Finding #2514', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/paper_grain_direction_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
