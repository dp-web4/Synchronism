...
fig.suptitle('Chemistry Session #2309: Rod Puppet Control Chemistry - γ~1 Coherence Analysis\n2172nd Phenomenon Type | Finding #2236', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/rod_puppet_control_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
