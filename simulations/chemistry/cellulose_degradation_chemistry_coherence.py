...
fig.suptitle('Chemistry Session #2298: Cellulose Degradation Chemistry - γ~1 Coherence Analysis\n2161st Phenomenon Type | Finding #2225', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/cellulose_degradation_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
