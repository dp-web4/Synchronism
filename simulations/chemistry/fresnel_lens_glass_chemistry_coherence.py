...
fig.suptitle('Chemistry Session #2381: Fresnel Lens Glass Chemistry - γ~1 Coherence Analysis\n2244th Phenomenon Type | Finding #2308', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/fresnel_lens_glass_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
