...
fig.suptitle('Chemistry Session #2006: Tire Rubber Compound Chemistry - γ~1 Coherence Analysis\n1869th Phenomenon Type | Finding #1933', fontsize=14, fontweight='bold')
...
plt.tight_layout(); plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/tire_rubber_compound_chemistry_coherence.png',dpi=150,bbox_inches='tight'); plt.close()
r=[t1,t2,t3,t4,t5,t6,t7,t8]; print(f"Session #2006: {sum(r)}/8"); print(f"  {r}")
