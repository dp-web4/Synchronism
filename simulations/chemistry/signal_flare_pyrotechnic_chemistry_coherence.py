...
fig.suptitle('Chemistry Session #2385: Signal Flare Pyrotechnic Chemistry - γ~1 Coherence Analysis\n2248th Phenomenon Type | Finding #2312', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/signal_flare_pyrotechnic_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
