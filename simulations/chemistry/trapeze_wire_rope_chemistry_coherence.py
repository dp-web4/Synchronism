...
fig.suptitle('Chemistry Session #2332: Trapeze Wire Rope Chemistry - \u03b3~1 Coherence Analysis\n2195th Phenomenon Type | Finding #2259', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/trapeze_wire_rope_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
