...
fig.suptitle('Chemistry Session #2595: Stirrup Stainless Steel Chemistry - γ~1 Coherence Analysis\n2458th Phenomenon Type | Finding #2522', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/stirrup_stainless_steel_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
