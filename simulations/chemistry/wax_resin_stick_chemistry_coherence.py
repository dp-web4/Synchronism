...
fig.suptitle('Chemistry Session #2648: Wax Resin Stick Chemistry - γ~1 Coherence Analysis\n2511th Phenomenon Type | Finding #2575', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/wax_resin_stick_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
