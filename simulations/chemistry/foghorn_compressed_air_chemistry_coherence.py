...
fig.suptitle('Chemistry Session #2383: Foghorn Compressed Air Chemistry - γ~1 Coherence Analysis\n2246th Phenomenon Type | Finding #2310', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/foghorn_compressed_air_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
