...
fig.suptitle('Chemistry Session #2652: Kiln Firing Cone Chemistry - γ~1 Coherence Analysis\n2515th Phenomenon Type | Finding #2579', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/kiln_firing_cone_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
