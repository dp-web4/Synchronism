...
fig.suptitle('Chemistry Session #2617: Court Line Paint Chemistry - γ~1 Coherence Analysis\n2480th Phenomenon Type | Finding #2544', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/court_line_paint_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
