...
fig.suptitle('Chemistry Session #1975: Glass Cleaner Chemistry - γ~1 Coherence Analysis\n1838th Phenomenon Type | Finding #1902', fontsize=14, fontweight='bold')
...
plt.tight_layout(); plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/glass_cleaner_chemistry_coherence.png',dpi=150,bbox_inches='tight'); plt.close()
r=[t1,t2,t3,t4,t5,t6,t7,t8]; print(f"Session #1975: {sum(r)}/8 validated"); print(f"  {r}")
