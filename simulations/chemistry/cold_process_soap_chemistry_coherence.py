...
fig.suptitle('Chemistry Session #2401: Cold Process Soap Chemistry - γ~1 Coherence Analysis\n2264th Phenomenon Type | Finding #2328', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/cold_process_soap_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
