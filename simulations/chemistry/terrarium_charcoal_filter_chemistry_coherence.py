...
fig.suptitle('Chemistry Session #2523: Terrarium Charcoal Activated Filter - γ~1 Coherence Analysis\n2386th Phenomenon Type | Finding #2450', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/terrarium_charcoal_filter_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
