...
fig.suptitle('Chemistry Session #2402: Hot Process Soap Chemistry - γ~1 Coherence Analysis\n2265th Phenomenon Type | Finding #2329', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/hot_process_soap_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
