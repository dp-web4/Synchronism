...
fig.suptitle('Chemistry Session #2429: Coral Substrate Aragonite - \u03b3~1 Coherence Analysis\n2292nd Phenomenon Type | Finding #2356', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/coral_substrate_s2429_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
