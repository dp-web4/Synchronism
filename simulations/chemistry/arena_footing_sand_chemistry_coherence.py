...
fig.suptitle('Chemistry Session #2598: Arena Footing Sand Chemistry - γ~1 Coherence Analysis\n2461st Phenomenon Type | Finding #2525', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/arena_footing_sand_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
