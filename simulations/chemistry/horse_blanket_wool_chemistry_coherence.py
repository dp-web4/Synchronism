...
fig.suptitle('Chemistry Session #2597: Horse Blanket Wool Chemistry - γ~1 Coherence Analysis\n2460th Phenomenon Type | Finding #2524', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/horse_blanket_wool_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
