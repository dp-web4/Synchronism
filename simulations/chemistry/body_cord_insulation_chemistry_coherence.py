...
fig.suptitle('Chemistry Session #2567: Body Cord Insulation Chemistry - γ~1 Coherence Analysis\n2430th Phenomenon Type | Finding #2494', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/body_cord_insulation_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
