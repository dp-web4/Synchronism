...
fig.suptitle('Chemistry Session #1971: Laundry Detergent Chemistry - γ~1 Coherence Analysis\n1834th Phenomenon Type | Finding #1898', fontsize=14, fontweight='bold')
...
plt.tight_layout(); plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/laundry_detergent_chemistry_coherence.png',dpi=150,bbox_inches='tight'); plt.close()
r=[t1,t2,t3,t4,t5,t6,t7,t8]; print(f"Session #1971: {sum(r)}/8 validated"); print(f"  {r}")
