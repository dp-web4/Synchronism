...
fig.suptitle('Chemistry Session #2603: Oarlock Bronze Chemistry - γ~1 Coherence Analysis\n2466th Phenomenon Type | Finding #2530', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/oarlock_bronze_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
