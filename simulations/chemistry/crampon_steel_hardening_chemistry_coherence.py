...
fig.suptitle('Chemistry Session #2556: Crampon Steel Hardening Chemistry - γ~1 Coherence Analysis\n2419th Phenomenon Type | Finding #2483', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/crampon_steel_hardening_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
