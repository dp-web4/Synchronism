...
fig.suptitle('Chemistry Session #2295: Book Adhesive Chemistry - γ~1 Coherence Analysis\n2158th Phenomenon Type | Finding #2222', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/book_adhesive_s2295_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
