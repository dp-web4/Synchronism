...
fig.suptitle('Chemistry Session #2046: Gel Candle Chemistry - γ~1 Coherence Analysis\n1909th Phenomenon Type | Finding #1973',fontsize=14,fontweight='bold')
...
plt.tight_layout(); plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/gel_candle_chemistry_coherence.png',dpi=150,bbox_inches='tight'); plt.close()
r=[t1,t2,t3,t4,t5,t6,t7,t8]; print(f"Session #2046: {sum(r)}/8"); print(f"  {r}")
