...
fig.suptitle('Chemistry Session #2325: Soot Carbon Particle Chemistry - γ~1 Coherence Analysis\n2188th Phenomenon Type | Finding #2252', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/soot_carbon_particle_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
