...
fig.suptitle('Chemistry Session #2629: Gimbal Bearing Steel Chemistry - γ~1 Coherence Analysis\n2492nd Phenomenon Type | Finding #2556', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/gimbal_bearing_steel_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
