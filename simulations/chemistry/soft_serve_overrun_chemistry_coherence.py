...
fig.suptitle('Chemistry Session #2318: Soft Serve Overrun Chemistry - \u03b3~1 Coherence Analysis\n2181st Phenomenon Type | Finding #2245', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/soft_serve_overrun_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
