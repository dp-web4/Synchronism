...
fig.suptitle('Chemistry Session #2424: Aquarium Dechlorination Thiosulfate - γ~1 Coherence Analysis\n2287th Phenomenon Type | Finding #2351', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/dechlorination_s2424_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
