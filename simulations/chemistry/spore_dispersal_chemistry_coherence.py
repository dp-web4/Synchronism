...
fig.suptitle('Chemistry Session #2363: Spore Dispersal Chemistry - γ~1 Coherence Analysis\n2226th Phenomenon Type | Finding #2290', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/spore_dispersal_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
