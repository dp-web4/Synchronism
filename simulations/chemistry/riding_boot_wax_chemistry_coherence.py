...
fig.suptitle('Chemistry Session #2596: Riding Boot Wax Chemistry - γ~1 Coherence Analysis\n2459th Phenomenon Type | Finding #2523', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/riding_boot_wax_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
