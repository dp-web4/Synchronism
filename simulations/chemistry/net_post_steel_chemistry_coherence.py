...
fig.suptitle('Chemistry Session #2618: Net Post Steel Chemistry - γ~1 Coherence Analysis\n2481st Phenomenon Type | Finding #2545', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/net_post_steel_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
