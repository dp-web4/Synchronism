...
fig.suptitle('Chemistry Session #2442: Calligraphy Nib Iridium Tipping - γ~1 Coherence Analysis\n2305th Phenomenon Type | Finding #2369', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/calligraphy_nib_iridium_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
