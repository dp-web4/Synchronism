...
fig.suptitle('Chemistry Session #2505: Bow Riser Aluminum Machining - γ~1 Coherence Analysis\n2368th Phenomenon Type | Finding #2432', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/bow_riser_aluminum_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
