...
fig.suptitle('Chemistry Session #2454: Specimen Borax Dehydration - γ~1 Coherence Analysis\n2317th Phenomenon Type | Finding #2381', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/borax_dehydration_s2454_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
