...
fig.suptitle('Chemistry Session #2425: Aquarium Plant CO2 Injection - γ~1 Coherence Analysis\n2288th Phenomenon Type | Finding #2352', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/aquarium_co2_injection_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
