...
fig.suptitle('Chemistry Session #2321: Creosote Buildup Chemistry - γ~1 Coherence Analysis\n2184th Phenomenon Type | Finding #2248', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/creosote_buildup_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
