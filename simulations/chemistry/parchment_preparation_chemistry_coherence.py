...
fig.suptitle('Chemistry Session #2292: Parchment Preparation Chemistry - γ~1 Coherence Analysis\n2155th Phenomenon Type | Finding #2219', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/parchment_preparation_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
