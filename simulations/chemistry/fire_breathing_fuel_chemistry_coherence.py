...
fig.suptitle('Chemistry Session #2336: Corn Starch Lycopodium Powder Flash Combustion - \u03b3~1 Coherence Analysis\n2199th Phenomenon Type | Finding #2263', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/fire_breathing_fuel_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
