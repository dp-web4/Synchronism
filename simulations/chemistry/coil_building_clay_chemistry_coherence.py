...
fig.suptitle('Chemistry Session #2657: Coil Building Clay Chemistry - γ~1 Coherence Analysis\n2520th Phenomenon Type | Finding #2584', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/coil_building_clay_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
