...
# Chemistry Session #1559: TDI/MDI Chemistry
# Toluene/methylene diisocyanate synthesis
...
fig.suptitle('TDI/MDI Chemistry (Diisocyanate Synthesis) - Coherence Boundary Analysis\nSynchronism Chemistry Session #1559', fontsize=14, fontweight='bold')

test_names = [
    'Phosgenation',
    'Amine-Phosgene Reaction',
    'Carbamoyl Chloride',
    'HCl Elimination',
    'TDI 2,4/2,6 Isomer Ratio',
    'MDI Polymeric Distribution',
    'Cold-Hot Phosgenation',
    'NCO Content Control'
]
test_descriptions = [
    'Phosgenation coherence',
    'Amine reactivity frac',
    'Intermediate stability',
    'Elimination rate',
    'Isomer selectivity',
    'MW distribution',
    'Thermal staging frac',
    'NCO endpoint frac'
]
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/tdi_mdi_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()

print(f"Session #1559: TDI/MDI Chemistry (Diisocyanate Synthesis)")
print(f"Boundaries validated: {boundaries_validated}/8")
print(f"Phenomenon type: 1422nd")
print(f"Finding #1486: TDI/MDI phosgenation amine-phosgene carbamoyl chloride pathway shows coherence boundary at γ~1 (N_corr=4)")
