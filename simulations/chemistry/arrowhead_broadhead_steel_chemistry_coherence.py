...
fig.suptitle('Chemistry Session #2506: Arrowhead Broadhead Steel Tempering - γ~1 Coherence Analysis\n2369th Phenomenon Type | Finding #2433', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/arrowhead_broadhead_steel_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
