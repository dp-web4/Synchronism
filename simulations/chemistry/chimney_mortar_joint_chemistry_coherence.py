...
fig.suptitle('Chemistry Session #2322: Chimney Mortar Joint Chemistry - γ~1 Coherence Analysis\n2185th Phenomenon Type | Finding #2249', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/chimney_mortar_joint_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
