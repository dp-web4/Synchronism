...
fig.suptitle('Chemistry Session #2362: Chitin Cell Wall Chemistry - γ~1 Coherence Analysis\n2225th Phenomenon Type | Finding #2289', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/chitin_cell_wall_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
