...
fig.suptitle('Chemistry Session #2653: Glaze Silica Flux Chemistry - γ~1 Coherence Analysis\n2516th Phenomenon Type | Finding #2580', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/glaze_silica_flux_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
