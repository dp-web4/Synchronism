...
fig.suptitle('Chemistry Session #2326: Flue Gas Condensation Chemistry - \u03b3~1 Coherence Analysis\n2189th Phenomenon Type | Finding #2253', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/flue_gas_condensation_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
