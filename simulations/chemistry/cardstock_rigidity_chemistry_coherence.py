...
fig.suptitle('Chemistry Session #2589: Cardstock Rigidity Chemistry - γ~1 Coherence Analysis\n2452nd Phenomenon Type | Finding #2516', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/cardstock_rigidity_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
