...
fig.suptitle('Chemistry Session #2456: Specimen Resin Embedding Acrylic - γ~1 Coherence Analysis\n2319th Phenomenon Type | Finding #2383', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/specimen_resin_s2456_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
