...
fig.suptitle('Chemistry Session #2334: Tent Canvas Waterproofing Chemistry - \u03b3~1 Coherence Analysis\n2197th Phenomenon Type | Finding #2261', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/tent_canvas_waterproofing_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
