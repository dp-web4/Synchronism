...
fig.suptitle('Chemistry Session #2011: Drywall/Gypsum Board Chemistry - γ~1 Coherence Analysis\n1874th Phenomenon Type | Finding #1938', fontsize=14, fontweight='bold')
...
plt.tight_layout(); plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/drywall_gypsum_chemistry_coherence.png',dpi=150,bbox_inches='tight'); plt.close()
r=[t1,t2,t3,t4,t5,t6,t7,t8]; print(f"Session #2011: {sum(r)}/8"); print(f"  {r}")
