...
fig.suptitle('Chemistry Session #2654: Slip Casting Plaster Chemistry - γ~1 Coherence Analysis\n2517th Phenomenon Type | Finding #2581', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/slip_casting_plaster_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
