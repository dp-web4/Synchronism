...
fig.suptitle('Chemistry Session #2460: Herbarium Specimen Press Drying - γ~1 Coherence Analysis\n2323rd Phenomenon Type | Finding #2387', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/mnt/c/exe/projects/ai-agents/Synchronism/simulations/chemistry/herbarium_press_drying_chemistry_coherence.png', dpi=150, bbox_inches='tight')
plt.close()
