...
This project is indexed by GitNexus as **Synchronism** (36943 symbols, 52700 relationships, 245 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
