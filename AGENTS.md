...
This project is indexed by GitNexus as **Synchronism** (33447 symbols, 49232 relationships, 249 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
