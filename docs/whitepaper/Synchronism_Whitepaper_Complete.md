...
- **~3,355 autonomous research sessions** (Nov 2025 - May 2026): 659 core + 2,679 chemistry + 17 gnosis
...
- The **A2ACW methodology** (AI-to-AI adversarial collaboration) is the project's structural counterweight: one AI defends claims, another challenges them to operational definitions. Output is falsifiable test cards, not consensus narratives. The Framework Stress Test arc (S617-628) and the Site-Archive-Audit sub-arc (S632-S659) are visible products of this methodology — the framework auditing itself into greater calibration, with S658-S659 turning the lens onto A2ACW's own catch rate (a self-simulated three-axis protocol caught 6/6 demoted claims; false-novelty calibration on closed physics remains the open item).
