...
**Status**: **ENGAGED — DISFAVOURED (2026-08-01), single-source.** Measured slope is **3.2× steeper** than the H(z)-tracking prediction (framework evolves a₀ *too slowly*) at the framework's own anchor a₀(0) = 1.04; ≈5σ low at z~1 on the point comparison. Arithmetic re-verified in-repo; the Ciocan measurement itself is external and not re-executable here.
