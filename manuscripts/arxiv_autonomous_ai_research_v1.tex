...
\begin{enumerate}
  ...
  \item \textbf{Cross-model peer review}: Periodic review by a different model family (GPT-4o, called ``Nova'') to identify artifact drift
...
\vspace{1em}
\noindent\textit{Code and Logs}: Available upon request for verification.
