...
\vspace{1em}
\noindent\textit{Code and Documentation}: Full source code, session logs, and documentation are publicly available at \url{https://github.com/dp-web4/} under the AGPL-3.0 license.
